...
Overall: 70.27%  (PASS 233 · PARTIAL 54 · FAIL 83 · UNKNOWN 1 · total 371)
Scored coverage: 99.73% (370 / 371 fixtures have a reference)
Env: DPI 300 · white-tol 10 · V2 multi-gate verdict · pdftoppm yes
Breadth: 203 distinct category/feature pairs have a fixture (NOT a % of all CSS).
By expected_support: implemented 265 · partial 34 · unsupported 72
...
- **box-shadow** — 87.50%
  ...
  - PARTIAL 0.70% box-shadow=border-radius — `box-shadow-border-radius` — Box-shadow on a border-radius element must adopt the same rounded corners.
